...
import com.philips.h2h.bama.platform.core.domain.entity.BaseAuditableEntity;
...
public class EntityOperationListener implements PreInsertEventListener, PreUpdateEventListener {
    ...
    private final static String DEFAULT_CREATE_OPERATOR = "default create operator (-1)";
    private final static String DEFAULT_UPDATE_OPERATOR = "default update operator (-2)";
     ...
     *
     * @param object target object to be converted
