...
package com.philips.h2h.bama.platform.file.image;
...
public interface ImageClipper {
     ...
     *
     * @param filePath          file path of target image
     * @param clippingDimension the dimension to be clipped with
     */
     ...
     *
     * @param filePath              file path of target image
     * @param clippingDimensionList the list of dimensions to be clipped with
     */
     ...
     *
     * @param directory         target directory with all images to be clipped
     * @param clippingDimension the dimension to be clipped with
     */
