...
package com.philips.h2h.bama.platform.security.realm;
...
import com.philips.h2h.bama.platform.security.authc.DefaultAuthenticationToken;
import com.philips.h2h.bama.platform.security.entity.Permission;
import com.philips.h2h.bama.platform.security.entity.Role;
import com.philips.h2h.bama.platform.security.entity.Subject;
...
public abstract class DefaultRealm extends AuthorizingRealm {
     ...
     *
     * @param principal the principal of user in pass-by token
     ...
     * authentication.
     *
     * @param authcToken the token with user pass-by principals and credentials info
     *                   from client
     * @return the user authentication info stored in datasource, it'll be used
     * for further authentication and authorization
     * @throws AuthenticationException any exception during this process cause authentication fail
     ...
     *
     * @param principals the principals of target subject
     ...
     *
     * @param info  the authorization info to add permission
     * @param roles the role list containing permissions
     */
