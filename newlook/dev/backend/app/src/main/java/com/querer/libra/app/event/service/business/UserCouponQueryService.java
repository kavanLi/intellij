...
public interface UserCouponQueryService {
    ...
    List <UserCoupon> findUserCouponsToday(@NotNull String uid);

    Long countUserCouponsBetweenRange(@NotNull Long ruleOid, @NotNull Date startDate, @NotNull Date endDate);

    Long countUserCouponsBetweenRangea(@NotNull Long couponOid, @NotNull Date startDate, @NotNull Date endDate);
}
